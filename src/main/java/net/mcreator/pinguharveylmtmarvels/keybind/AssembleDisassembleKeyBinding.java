...
package net.mcreator.pinguharveylmtmarvels.keybind;
...
public class AssembleDisassembleKeyBinding extends PingusharveymarvelModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public AssembleDisassembleKeyBinding(PingusharveymarvelModElements instance) {
		super(instance, 4);
	...
	public void initElements() {
		keys = new KeyBinding("key.pingusharveymarvel.assemble_disassemble", GLFW.GLFW_KEY_Z, "key.categories.iron_man");
